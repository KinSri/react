...
const App = () => {
   const jobOpenings = [
    ...
    {
      brandLogo: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS2tOKniEmj59RYjBLBfdN7ENpRBQR5xXZ4zhk5EPbKNw&s=10",
      companyName: "IBM",
  ...
  return (
    <div className='parent'>
       {jobOpenings.map(function (elem, idx) {
        return <div key={idx}>
          <Card company={elem.companyName} datePosted={elem.datePosted} post={elem.post} tag1={elem.tag1} 
          brandLogo={elem.brandLogo} pay={elem.pay} tag2={elem.tag2} location={elem.location} />
